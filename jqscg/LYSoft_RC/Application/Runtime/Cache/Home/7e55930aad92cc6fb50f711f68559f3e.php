...
<html lang="zh">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/LySoft_RC/Public/css/rc-ddgz.css" />
		<title></title>
	</head>
	<script>
	...
	<body>
		<div id="ddgz">
			<div class="ddgzTitle"><a href="<?php echo U('Jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>订单跟踪</div>
			<div class="ddgzSelectBox">
				<div class="floor">
					...
					<div class="aBh">按编号<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
		...
		<script src="/LySoft_RC/Public/js/rc-ddgz.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>