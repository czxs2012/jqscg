...
<html lang="zh">
	...
	<body>
		<div id="template">
			<div class="templateTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>外发纱线统计</div>
			<div class="templateSelectBox">
				<div class="floor">
					...
					<div class="aChck">按出货仓库<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
		...
		<script src="/LySoft_RC/Public/js/rc-wfsxtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>