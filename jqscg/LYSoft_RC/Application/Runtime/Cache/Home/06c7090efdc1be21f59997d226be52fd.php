...
<html lang="zh">
	...
	<body>
		<div id="template">
			<div class="templateTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>退料开单统计</div>
			<div class="templateSelectBox">
				<div class="floor">
					<div class="aYggh">按员工工号<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
		...
		<script src="/LySoft_RC/Public/js/rc-tlkdtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>