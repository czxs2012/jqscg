...
<html lang="zh">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/LySoft_RC/Public/css/rc-xsfhtj.css" />
		<title></title>
	</head>
	<body>
		<div id="xsfhtj">
			<div class="xsfhtjTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>销售发货统计</div>
			<div class="xsfhtjSelectBox">
				<div class="floor">
			...
			<div id="xsfhtjContentMx">
				...
				<ul>
					...
					<li>
						...
						<div class="liline">
							<div style="width: 100%;"><span>开单单号：</span><p>SDC5464456456466</p></div>
						</div>
						<div class="liline">
		...
		<script src="/LySoft_RC/Public/js/rc-xsfhtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>