...
(function(window, $) {
				...
				li.innerHTML =
					`<div class="liContent">
								<div class="liContentTop">
									<div class="liName"><span style="margin-left:.3rem;font-size:.8rem;">纱线:</span><div>${this.data2[key].sxmc}</div></div>
									<div class="liZt"></div>
	...
	class CprktjSelectBox {
		...
		eventRegister(option) {
			...
			$(this.e).find('.aDcck').click(() => {
				option.aDcck($(this.e).find('.aDcck'))
			});
			$(this.e).find('.aDrck').click(() => {
				option.aDrck($(this.e).find('.aDrck'))
			});
