...
<html lang="zh">
	...
	<body>
		<div id="template">
			<div class="templateTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>纱线调拨统计</div>
		...
		<script src="/LySoft_RC/Public/js/rc-sxdbtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>