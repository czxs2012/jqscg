...
<html lang="zh">
	...
	<body>
		<div id="template">
			<div class="templateTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>销售退货统计</div>
		...
		<script src="/LySoft_RC/Public/js/rc-xsthtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>