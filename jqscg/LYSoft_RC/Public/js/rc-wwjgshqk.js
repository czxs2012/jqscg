				...
				li.innerHTML =
					`<div class="liContent">
								...
								<div class="liContentMiddle">
									...
									<div><span>加工商：</span>${this.data2[key].jgs}</div>
								</div>
								<div class="liContentMiddle">
									<div><span>流水号：</span>${this.data2[key].lsh}</div>
									<div><span>成品规格：</span>${this.data2[key].cpgg}</div>
								</div>
		...
		init(data) {
			...
			ul.innerHTML =
				`<li>${data.khmc}</li>
						<li>
						<div class="liline">
							<div><span>加工商：</span>${data.jgs}</div>
							...
							<div class="liline">
								...
								<div><span>成品颜色：</span>${data.cpys}</div>
							</div>
							<div class="liline">
								<div><span>单位：</span>${data.dw}</div>
								<div><span>成品规格：</span>${data.cpgg}</div>
							</div>
							<div class="liline">
								<div><span>外发匹数：</span>${data.wfps}</div>
								<div><span>外发重量：</span>${data.wfzl}</div>
							</div>
							<div class="liline">
								<div><span>来货匹数：</span>${data.lhps}</div>
								<div><span>来货重量：</span>${data.lhzl}</div>
							</div>
							<div class="liline">
								<div><span>未来匹数：</span>${data.wlps}</div>
								<div><span>未来重量：</span>${data.wlzl}</div>
							</div>
							<div class="liline">
							...
							<div class="liline">
								...
								<div><span>损耗：</span>${data.sh}</div>
							</div>
							<div class="liline">
								<div><span>额损耗：</span>${data.esh}</div>
								<div><span>损耗率：</span>${data.shl}</div>
							</div>
							<div class="liline">
