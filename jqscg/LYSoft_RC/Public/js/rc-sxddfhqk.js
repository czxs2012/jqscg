				...
				li.innerHTML =
					`<div class="liContent">
								...
								<div class="liContentMiddle">
									...
									<div><span>发货件数：</span>${this.data2[key].fhjs}</div>
								</div>
								<div class="liContentMiddle">
			...
			ul.innerHTML =
				`<li>${data.khmc}</li>
						<li>
							...
							<div class="liline">
								<div><span>订购数量：</span>${data.dgsl}</div>
								<div><span>订购件数：</span>${data.dgjs}</div>
							</div>
							<div class="liline">
								<div><span>发货数量：</span>${data.fhsl}</div>
								<div><span>发货件数：</span>${data.fhjs}</div>
							</div>
							<div class="liline">
								<div><span>未发数量：</span>${data.wfsl}</div>
							</div>
							<div class="liline">
