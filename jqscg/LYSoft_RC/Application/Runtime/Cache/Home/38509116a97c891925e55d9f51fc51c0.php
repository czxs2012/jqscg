...
<html lang="zh">
	...
	<body>
		<div id="template">
			<div class="templateTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>产品盘点统计</div>
			<div class="templateSelectBox">
				<div class="floor">
					<div class="aSj">按时间<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
					<div class="aLhs">按来货商<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
		...
		<script src="/LySoft_RC/Public/js/rc-cppdtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>