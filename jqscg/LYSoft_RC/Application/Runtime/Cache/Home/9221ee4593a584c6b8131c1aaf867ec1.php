...
<html lang="zh">
	...
	<body>
		<div id="template">
			<div class="templateTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>产品调拨统计</div>
			<div class="templateSelectBox">
				<div class="floor">
					<div class="aSj">按时间<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
					<div class="aDcck">按调出仓库<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
					<div class="aDrck">按调入仓库<img src="/LySoft_RC/Public/images/img/arrow.png"></div>
		...
		<script src="/LySoft_RC/Public/js/rc-cpdbtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>