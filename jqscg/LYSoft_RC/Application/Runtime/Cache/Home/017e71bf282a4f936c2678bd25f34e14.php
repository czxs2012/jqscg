...
<html lang="zh">
	...
	<body>
		<div id="zjwl">
			<div class="zjwlTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>产品报价</div>
		...
		<script src="/LySoft_RC/Public/js/rc-cpbj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>