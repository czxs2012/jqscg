...
<html lang="zh">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/LySoft_RC/Public/css/rc-xskdtj.css" />
		<title></title>
	</head>
	<script>
	...
	<body>
		<div id="xskdtj">
			<div class="xskdtjTitle"><a href="<?php echo U('jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>纱线销售开单统计</div>
			<div class="xskdtjSelectBox">
				<div class="floor">
				...
				<div class="floor2">
					...
					<div class="aGh">按缸号/机号</div>
				</div>
			</div>
			<div class="xskdtjContent">
				<ul>
					<li>
						<div class="liContent">
		...
		<script src="/LySoft_RC/Public/js/rc-sxxskdtj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>