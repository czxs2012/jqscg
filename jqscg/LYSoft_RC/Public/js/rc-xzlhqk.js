				...
				li.innerHTML =
					`<div class="liContent">
								...
								<div class="liContentBottom">
									<div><span style="margin-rijht: .5rem;">开单单号：</span>${this.data2[key].kddh}</div>
								</div>
							</div>`;
			...
			ul.innerHTML =
				`<li>${data.jgs}</li>
						<li>
							...
							<div class="liline">
								<div><span>下织匹数：</span>${data.xzps}</div>
								<div><span>下织数量：</span>${data.xzsl}</div>
							</div>
							<div class="liline">
							...
							<div class="liline">
								<div><span>结单状态：</span>${data.jdzt}</div>
							</div>
							<div class="liline">
