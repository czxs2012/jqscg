...
<html lang="zh">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/LySoft_RC/Public/css/rc-cprktj.css" />
		<title></title>
	</head>
	<script>
	...
	<body>
		<div id="cprktj">
			<div class="cprktjTitle"><a href="<?php echo U('Jh/jh1');?>"><img src="/LySoft_RC/Public/images/img/blue-back.png"></a>纱线入库统计</div>
			<div class="cprktjSelectBox">
				<div class="floor">
		...
		<script src="/LySoft_RC/Public/js/rc-sxrktj.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>