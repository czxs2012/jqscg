				...
				li.innerHTML =
					`<div class="liContent">
								<div class="liContentTop">
									<div class="liName">${this.data2[key].cppm}</div>
									<div class="liZt"></div>
								...
								<div class="liContentMiddle">
									<div><span>批号：</span>${this.data2[key].ph}</div>
									<div><span>编号：</span>${this.data2[key].cpbh}</div>
								</div>
								<div class="liContentBottom">
									<div><span style="margin-right: .5rem;">单号：</span>${this.data2[key].dh}</div>
								</div>
							</div>`;
			...
			ul.innerHTML =
				`<li>${data.cppm}</li>
						<li>
							...
							<div class="liline">
								<div><span>编号：</span>${data.cpbh}</div>
							...
							<div class="liline">
								<div><span>总重量：</span>${data.zzl}</div>
							...
							<div class="liline">
								<div style="width: 100%;"><span>单号：</span><p>${data.dh}</p></div>
							</div>
						</li>`;
